...
(function () {
  ...
  check(rp.profile.evidence.benchmarked === 1, 'recipeProfile evidence: only close-up is benchmarked (got ' + (rp.profile.evidence && rp.profile.evidence.benchmarked) + ')');
  check(rp.profile.evidence.confidenceFloor === 'heuristic', 'recipeProfile evidence floor should be heuristic when any heuristic atom is present');
